...
<style lang="scss" scoped>
  .login-main{
    min-height: 100vh;
    overflow: hidden;
    background: url("../src/assets/login-bg.jpg") no-repeat center;
    ...
    .login-form{
      ...
      input{
        ...
        &.user-name:focus{
          background: url("../src/assets/username-focus.png") no-repeat 8px center;
          background-size: 22px 24px;
        }
        &.user-name{
          background: url("../src/assets/username-blur.png") no-repeat 8px center;
          background-size: 22px 24px;
        }
        &.user-pwd:focus{
          margin-top: 25px;
          background: url("../src/assets/password-focus.png") no-repeat left center;
          background-position-x: 8px;
        }
        &.user-pwd{
          margin-top: 25px;
          background: url("../src/assets/password-blur.png") no-repeat left center;
          background-position-x: 8px;
        }
      }
      button{
